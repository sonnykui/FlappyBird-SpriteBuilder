...
- (void)update:(CCTime)delta
{
    ...
    for (CCNode *bush in _bushes) {
        ...
        CGPoint bushScreenPosition = [_parallaxBackground convertToNodeSpace:bushWorldPosition];
    ...
    for (CCNode *cloud in _clouds) {
        ...
        // get the screen position of the bush
        CGPoint cloudScreenPosition = [_parallaxBackground convertToNodeSpace:cloudWorldPosition];
